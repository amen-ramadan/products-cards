...
export const productValidation = (product: { title: string; description: string; imageURL: string; price: string; colors: string[] }): { title: string; description: string; imageURL: string; price: string; colors: string } => {
